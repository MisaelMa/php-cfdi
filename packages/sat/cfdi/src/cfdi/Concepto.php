...
class Concepto extends BaseImpuestos
{
  ...
  {
    $cloneParte = array_merge($parte, [
      'Cantidad' => floatval($parte['Cantidad'] ?? 0),
      'ValorUnitario' => floatval($parte['ValorUnitario'] ?? 0),
      'Importe' => floatval($parte['Importe'] ?? $parte['ValorUnitario'] ?? 0),
    ]);
